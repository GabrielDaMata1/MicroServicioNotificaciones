...
{
    /// <summary>
    /// Clase Handler que se encarga notificar al subastador cuando el usuario ganador de la subasta confirme reclama su premio.
    /// </summary>
    public class EnviarCorreoSubastadorConfirmacionReclamoPremioHandler : IRequestHandler<EnviarCorreoSubastadorConfirmacionReclamoPremioCommand, bool>
    {
        /// <summary>
        ...
        public EnviarCorreoSubastadorConfirmacionReclamoPremioHandler(IEmailSender emailSender)
        {
            _emailSender = emailSender;
        }
        /// <summary>
        /// Metodo que se encarga de procesar el envio de un correo al subastador cuando un usuario confirma el reclamo del premio de la subasta en la que ganó.
        /// </summary>
        ...
        public async Task<bool> Handle(EnviarCorreoSubastadorConfirmacionReclamoPremioCommand request, CancellationToken cancellationToken)
        {

            try
            {
                // Se genera el contenido del correo a enviar.
                var contenidoCorreo = GeneradorContenidoCorreo.ContenidoConfirmaciónReclamoPremioSubasta(request.reclamoPremioDto.NombreSubasta, request.reclamoPremioDto.CorreoUsuario);
